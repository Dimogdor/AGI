...
pour échanger l'état de jeu. La mise en relation utilise des infrastructures
publiques de signalisation (trackers/relais), qui voient une adresse IP le
temps d'établir la connexion — comme toute communication réseau. Aucun
contenu de jeu n'est conservé sur un serveur ; nous n'exploitons aucun serveur
de jeu et n'enregistrons aucune partie.
